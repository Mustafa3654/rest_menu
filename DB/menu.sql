...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 18, 2025 at 01:07 PM
...
--
-- Database: `u907225650_caffeaborami`
--
...
(433, 'Turkish Cheese', 'KAAK', 300000, '0', '', 0, 0),
(434, 'Chocolate', 'KAAK', 150000, '0', '', 0, 0),
(435, 'Add (Banana And Strawberry )', 'KAAK', 50000, '0', '', 0, 0),
(436, 'Add (Banana and Strawberry)', 'SAJ', 50000, '0', '', 0, 0),
(437, 'Master Salt', 'CHIPS', 60000, '0', '', 0, 0),
(438, 'Master BBQ', 'CHIPS', 60000, '0', '', 0, 0),
(439, 'Master Vinegar', 'CHIPS', 60000, '0', '', 0, 0);
...
--
ALTER TABLE `items`
  MODIFY `item_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=440;
